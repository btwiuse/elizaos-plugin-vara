        ...
        [
            {
                user: "{{user1}}",
                content: {
                    text: "Send 100 DOT to 5GWbvXjefEvXXETtKQH7YBsUaPc379KAQATW1eqeJT26cbsK",
                },
            },
            {
                user: "{{agent}}",
            ...
            },
            {
                user: "{{agent}}",
                content: {
                    text: "Successfully sent 100 DOT to 5GWbvXjefEvXXETtKQH7YBsUaPc379KAQATW1eqeJT26cbsK\nTransaction: 0x748057951ff79cea6de0e13b2ef70a1e9f443e9c83ed90e5601f8b45144a4ed4",
                },
            },
        ],
        [
            {
                user: "{{user1}}",
                content: {
                    text: "Please send 100 DOT tokens to 5GWbvXjefEvXXETtKQH7YBsUaPc379KAQATW1eqeJT26cbsK",
                },
            },
            {
                user: "{{agent}}",
